...
public class ArrayUtils {
    ...
    public static int[] toIntArray(String str) {
        ...
        } catch (Exception onlyDigit) {
            System.err.println("There are letters and it is necessary that there are only numbers");
            System.exit(-1);
        }
    ...
    */
     ...
     */
    public static int[] readIntArrayFromFile(String fileName) throws Exception {
        try {
            String line = readLinesFromFile(fileName)[0];
     ...
     */
    public static double[] readDoubleArrayFromFile(String fileName) throws Exception {
        try {
    ...
    public static double[][] readDoubleArray2FromFile(String fileName) throws Exception {
        try {
